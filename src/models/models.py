...
class DiagnosticMapResult(BaseModel):
    """Result of generating a visual diagnostic map overlay."""
    plant_id: str
    map_path: str = Field(..., description="Path to the generated PNG map file.")
    coverage_pct: float
