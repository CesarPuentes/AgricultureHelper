...
class AlertResult(BaseModel):
    """A single alert generated by the deterministic alert engine."""
    alert_type: str = Field(..., description="Type of alert: 'watchdog' | 'vision_delta'")
    severity: str = Field(..., description="Alert severity: 'critical' | 'warning'")
    plant_id: str
    message: str
    triggered_at: datetime = Field(default_factory=datetime.now)
    details: dict = Field(default_factory=dict, description="Numeric support data.")
